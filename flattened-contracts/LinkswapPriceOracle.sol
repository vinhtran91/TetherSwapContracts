...
// File: contracts/TetherswapPriceOracle.sol
...
contract TetherswapPriceOracle is ITetherswapPriceOracle {
        ...
        returns (uint256)
    {
        if (token == yflToken) {
            ...
            require(usdPerWeth > 0 && usdPerWeth <= INT256_MAX, "TetherswapPriceOracle: INVALID_USD_PRICE");
            ...
            require(usdPrice > 0 && usdPrice <= INT256_MAX, "TetherswapPriceOracle: INVALID_USD_PRICE");
